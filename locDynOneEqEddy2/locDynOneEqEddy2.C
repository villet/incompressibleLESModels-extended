...
defineTypeNameAndDebug(locDynOneEqEddy2, 0);
addToRunTimeSelectionTable(LESModel, locDynOneEqEddy2, dictionary);

// * * * * * * * * * * * * * Private Member Functions  * * * * * * * * * * * //

volScalarField locDynOneEqEddy2::ck
(
...
volScalarField locDynOneEqEddy2::ce
(
    const volSymmTensorField& D,
    const volScalarField& KK
) const
...
locDynOneEqEddy2::locDynOneEqEddy2
(
...
void locDynOneEqEddy2::correct(const tmp<volTensorField>& gradU)
{
